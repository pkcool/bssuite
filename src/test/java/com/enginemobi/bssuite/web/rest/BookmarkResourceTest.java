...
private static final BookmarkArea DEFAULT_BOOKMARK_AREA = BookmarkArea.PURCHASEORDER;
    ...
    private static final DateTime DEFAULT_LAST_EDITED_ON = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_LAST_EDITED_ON = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_LAST_EDITED_ON_STR = dateTimeFormatter.print(DEFAULT_LAST_EDITED_ON);
    ...
    public void createBookmark() throws Exception {
        ...
        assertThat(testBookmark.getCreatedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_CREATED_ON);
        ...
        assertThat(testBookmark.getLastEditedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_LAST_EDITED_ON);
    ...
    public void updateBookmark() throws Exception {
        ...
        Bookmark testBookmark = bookmarks.get(bookmarks.size() - 1);
        assertThat(testBookmark.getCreatedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_CREATED_ON);
        ...
        assertThat(testBookmark.getLastEditedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_LAST_EDITED_ON);
