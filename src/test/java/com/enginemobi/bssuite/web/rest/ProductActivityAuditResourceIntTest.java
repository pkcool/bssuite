...
@WebAppConfiguration
@IntegrationTest
public class ProductActivityAuditResourceIntTest {
    ...
    public void createProductActivityAudit() throws Exception {
        ...
        assertThat(testProductActivityAudit.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
    ...
    public void updateProductActivityAudit() throws Exception {
        ...
        ProductActivityAudit testProductActivityAudit = productActivityAudits.get(productActivityAudits.size() - 1);
        assertThat(testProductActivityAudit.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
