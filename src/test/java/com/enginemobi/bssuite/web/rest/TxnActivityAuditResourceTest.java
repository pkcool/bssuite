...
@WebAppConfiguration
@IntegrationTest
public class TxnActivityAuditResourceTest {

    private static final DateTimeFormatter dateTimeFormatter = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss'Z'");


    private static final DateTime DEFAULT_EDITED_ON = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_EDITED_ON = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_EDITED_ON_STR = dateTimeFormatter.print(DEFAULT_EDITED_ON);
...
private static final TxnEditType DEFAULT_EDIT_TYPE = TxnEditType.ADD;
    ...
    public void createTxnActivityAudit() throws Exception {
        ...
        assertThat(testTxnActivityAudit.getEditedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_EDITED_ON);
    ...
    public void updateTxnActivityAudit() throws Exception {
        ...
        TxnActivityAudit testTxnActivityAudit = txnActivityAudits.get(txnActivityAudits.size() - 1);
        assertThat(testTxnActivityAudit.getEditedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_EDITED_ON);
