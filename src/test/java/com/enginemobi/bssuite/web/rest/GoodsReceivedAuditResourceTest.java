...
@WebAppConfiguration
@IntegrationTest
public class GoodsReceivedAuditResourceTest {

    private static final DateTimeFormatter dateTimeFormatter = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss'Z'");


    private static final DateTime DEFAULT_RECEIVED_ON = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_RECEIVED_ON = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_RECEIVED_ON_STR = dateTimeFormatter.print(DEFAULT_RECEIVED_ON);
...
private static final GoodsReceiptType DEFAULT_TYPE_RECEIPT = GoodsReceiptType.PURCHASEORDER;
    ...
    public void createGoodsReceivedAudit() throws Exception {
        ...
        assertThat(testGoodsReceivedAudit.getReceivedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_RECEIVED_ON);
    ...
    public void updateGoodsReceivedAudit() throws Exception {
        ...
        GoodsReceivedAudit testGoodsReceivedAudit = goodsReceivedAudits.get(goodsReceivedAudits.size() - 1);
        assertThat(testGoodsReceivedAudit.getReceivedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_RECEIVED_ON);
