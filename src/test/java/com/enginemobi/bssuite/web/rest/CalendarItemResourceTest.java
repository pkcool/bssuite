...
@WebAppConfiguration
@IntegrationTest
public class CalendarItemResourceTest {
    ...
    private static final DateTime DEFAULT_STARTED_ON = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_STARTED_ON = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_STARTED_ON_STR = dateTimeFormatter.print(DEFAULT_STARTED_ON);

    private static final DateTime DEFAULT_ENDED_ON = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_ENDED_ON = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_ENDED_ON_STR = dateTimeFormatter.print(DEFAULT_ENDED_ON);
    ...
    private static final DateTime DEFAULT_REMAINDER_TIME = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_REMAINDER_TIME = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_REMAINDER_TIME_STR = dateTimeFormatter.print(DEFAULT_REMAINDER_TIME);
...
private static final AlarmType DEFAULT_ALARM_TYPE = AlarmType.SOUND;
    ...
    public void createCalendarItem() throws Exception {
        ...
        assertThat(testCalendarItem.getStartedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_STARTED_ON);
        assertThat(testCalendarItem.getEndedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_ENDED_ON);
        ...
        assertThat(testCalendarItem.getRemainderTime().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_REMAINDER_TIME);
    ...
    public void updateCalendarItem() throws Exception {
        ...
        assertThat(testCalendarItem.getStartedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_STARTED_ON);
        assertThat(testCalendarItem.getEndedOn().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_ENDED_ON);
        ...
        assertThat(testCalendarItem.getRemainderTime().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_REMAINDER_TIME);
