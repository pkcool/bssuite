...
/**
 * Performance test for the InvoiceLineItem entity.
 */
class InvoiceLineItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvoiceLineItem entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all invoiceLineItems")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created invoiceLineItem")
                .get("${new_invoiceLineItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoiceLineItem")
            .delete("${new_invoiceLineItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
