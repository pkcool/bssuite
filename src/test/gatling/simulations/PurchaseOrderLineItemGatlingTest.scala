...
/**
 * Performance test for the PurchaseOrderLineItem entity.
 */
class PurchaseOrderLineItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PurchaseOrderLineItem entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all purchaseOrderLineItems")
            .get("/api/purchaseOrderLineItems")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created purchaseOrderLineItem")
                .get("${new_purchaseOrderLineItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created purchaseOrderLineItem")
            .delete("${new_purchaseOrderLineItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
