...
/**
 * Performance test for the SalesOrderLineItem entity.
 */
class SalesOrderLineItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SalesOrderLineItem entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all salesOrderLineItems")
            .get("/api/salesOrderLineItems")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created salesOrderLineItem")
                .get("${new_salesOrderLineItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created salesOrderLineItem")
            .delete("${new_salesOrderLineItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
