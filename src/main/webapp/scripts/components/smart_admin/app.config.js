...
appConfig.sound_path = "/scripts/components/smart_admin/sound/";
...
if (appConfig.voice_command) {
        ...
        'help' : function() {
            ...
            $('#voiceModal').removeData('modal').modal( { remote: "scripts/components/smart_admin/layout/partials/voice-commands.tpl.html", show: true } );
            if ($('#speech-btn .popover').is(':visible')) {
                $('#speech-btn .popover').fadeOut(250);
            }
...
appConfig.apiRootUrl = '/scripts/components/smart_admin/api';
