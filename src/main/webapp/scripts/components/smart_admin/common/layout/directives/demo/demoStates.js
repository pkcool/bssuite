...
angular.module('bssuiteApp').directive('demoStates', function ($rootScope) {
    return {
        restrict: 'EA',
        replace: true,
        templateUrl: 'scripts/components/smart_admin/common/layout/directives/demo/demo-states.tpl.html',
        scope: true,
