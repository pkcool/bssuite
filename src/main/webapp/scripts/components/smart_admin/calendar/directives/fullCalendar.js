...
angular.module('bssuiteApp').directive('fullCalendar', function (CalendarEvent, $log, $timeout) {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'scripts/components/smart_admin/calendar/directives/full-calendar.tpl.html',
        scope: {
            events: "=events"
        },
